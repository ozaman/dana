...
include("../config.php");
    ...
    $sql = "INSERT INTO dn_hotel_package(province,hotel_name,hotel_id,company_name,room_type,background,attraction,location,post_date) VALUES ('".$_POST[province]."','".$_POST[hotelname]."','".$_POST[hotel_id]."','".$_POST[company]."','".$_POST[roomtype]."','".$_POST[background]."','".$_POST[attraction]."','".$_POST[location]."','".time()."')";
