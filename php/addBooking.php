<?php
include("../config.php");
    $sql = "INSERT INTO dn_booking(program,ondate,ontime,agent_id,agent_name,adult,child,total,pickup_place,to_place,name,phone,phonecode,email,user_id,user_name,package_name,total_price,adult_price,child_price,room_number,type,province,province_id,transfer_price,company_id,company_name,pro_class,area,net_price_adult,net_price_child,flight,booking_date,post_date,owner,listcar, checkin,checkout, nights,hotel_name,room_type,due_date) VALUES ('".$_POST[program]."','".$_POST[ondate]."','".$_POST[ontime]."','".$_POST[agent]."','".$_POST[agentname]."','".$_POST[adult]."','".$_POST[child]."','".$_POST[total]."','".$_POST[place]."','".$_POST[toplace]."','".$_POST[name]."','".$_POST[phone]."','".$_POST[phonecode]."','".$_POST[email]."','".$_POST[postid]."','".$_POST[postname]."','".$_POST[package_name]."','".$_POST[total_price]."','".$_POST[adult_price]."','".$_POST[child_price]."','".$_POST[roomnumber]."','".$_POST[type]."','".$_POST[province]."','".$_POST[province_id]."','".$_POST[transfer_price]."','".$_POST[company_id]."','".$_POST[company_name]."','".$_POST[pro_class]."','".$_POST[area]."','".$_POST[net_price_adult]."','".$_POST[net_price_child]."','".$_POST[flight]."','".date('d/m/Y H:i:s')."','".time()."','".$_POST[owner]."','".$_POST[listcar]."','".$_POST[checkin]."','".$_POST[checkout]."','".$_POST[night]."','".$_POST[hotel_name]."','".$_POST[room_type]."','".$_POST[duedate]."')";
