...
(function(S, X, u) {
    ...
    function yc(a, b, d) {
        ...
        var c = function() {
                a = B(a);
                if (a.injector()) { var c = a[0] === X ? "document" : ua(a); throw Aa("btstrpd", c.replace(/</, "&lt;").replace(/>/, "&gt;")); }
                b = b || [];
                    ...
                    try {
                        ...
                        if (H(t.bindToController)) {
                            ...
                            a: if (R && E(R)) V = R;
                                    ...
                                    if (E(v)) { var n = Uc.exec(v); if (n) { V = n[3]; break a } }
                                    V = void 0
                                }
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function(a,
            ...
            function Z(a, b, d, e, f, g, h, l, m) {
                ...
                for (var A = -Number.MAX_VALUE, R = m.newScopeDirective, T = m.controllerDirectives, O = m.newIsolateScopeDirective, J = m.templateDirective, n = m.nonTlbTranscludeDirective, ga = !1, L = !1, aa = m.hasElementTranscludeDirective, Z = d.$$element = B(b), q, x, P, Ia =
                    ...
                    else if (q.compile) try { G = q.compile(Z, d, Ia), z(G) ? t(null, G, N, Q) : G && t(G.pre, G.post, N, Q) } catch (da) { c(da, ua(Z)) }
    ...
    function Uf(a, b, d,
        ...
        return function(e, h, k, l, m, r, t, A) {
            ...
            if ("jsonp" == F(e)) {
                ...
                if (A) try { w.responseType = A } catch (ga) { if ("json" !== A) throw ga; }
                w.send(q(k) ? null : k)
            }
            if (0 < r) var L = d(v, r);
            ...
            function(d, c, e) {
                ...
                function h(f, h, m, r) {
                    ...
                    for (var C, w, n = 0, L = [], s = [], D = f.length, J = [], K = []; n < D;)
                        ...
                        else { n !== D && J.push(g(f.substring(n))); break }
    ...
    function kf() {
        ...
        this.$get = ["$filter", function(d) {
            ...
            function e(a, b, d, e, f) {
                ...
                return a.$watch(function(a) {
                    for (var b = !1, d = 0, f = g.length; d < f; d++) { var k = g[d](a); if (b || (b = !c(k, l[d]))) m[d] = k, l[d] = k && ec(k) }
                    b && (h = e(a, u, u, m));
                    return h
                }, b, d, f)
            }
    ...
    function lf() {
        ...
        this.$get = ["$injector", "$exceptionHandler", "$parse", "$browser", function(f, g, h, k) {
            ...
            function p() {
                for (; aa.length;) try { aa.shift()() } catch (a) { g(a) }
                e = null
            }

            function C() { null === e && (e = k.defer(function() { w.$apply(p) })) }
            r.prototype = {
                constructor: r,
                $new: function(b, c) {
                    var d;
                ...
                $digest: function() {
                    ...
                    do {
                        r = !1;
                        for (A = this; u.length;) {
                            try { C = u.shift(), C.scope.$eval(C.expression, C.locals) } catch (aa) { g(aa) }
                            c = null
                        }
                        a: do {
                            if (l = A.$$watchers)
        ...
        this.$get = ["$rootScope", "$browser", "$q", "$$q", "$exceptionHandler", function(a, b, d, c, e) {
            function f(f, k, l) {
                ...
                var m = ra.call(arguments, 3),
                    ...
                    q;
                q = b.defer(function() {
                    try { t.resolve(f.apply(null, m)) } catch (b) { t.reject(b), e(b) } finally { delete g[n.$$timeoutId] }
                    r || a.$apply()
                }, k);
                n.$$timeoutId = q;
                g[q] = t;
    ...
    function kb(a, b, d, c) {
        return function(e, f, g, h, k, l, m) {
            ...
            function n(a) { return y(a) && !da(a) ? d(a) || u : a }
            Hd(e, f, g, h);
            jb(e, f, g, h, k, l);
    ...
    var I = Array.isArray,
        ...
        pb = function() {
            ...
            for (b = 0; b <
                d; ++b)
                if (c = Oa[b], a = X.querySelector("[" + c.replace(":", "\\:") + "jq]")) { e = a.getAttribute(c + "jq"); break }
            return pb.name_ = e
        },
    ...
    n({
        ...
        text: function() {
            function a(a, d) {
                if (q(d)) { var c = a.nodeType; return 1 === c || c === Na ? a.textContent : "" }
                a.textContent = d
            }
            a.$dv = "";
            return a
    ...
    n(Zc, function(a, b) {
        tb[b] = function() {
            return {
                ...
                link: function(a,
                    c, e) {
                    if ("ngPattern" === b && "/" == e.ngPattern.charAt(0) && (c = e.ngPattern.match(lg))) { e.$set("ngPattern", new RegExp(c[1], c[2])); return }
