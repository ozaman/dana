                                ...
                                <form class="form-group "  >
                                  ...
                                  <div class="form-group form-inline">
                                    ...
                                    <div class="form-group form-inline">
                                        ...
                                        <input type="text" class=" form-control" size="100" maxlength="200" placeholder = "Max length 200 characters" id="Transfer_topic" name="transfer_topic" ng-model="transfer_topic" ng-change="transfername(transfer_topic)" required/>
                                    </div>
                                    ...
                                    <div class=" form-group form-inline " >
                                                <label class="label-tour">Person(s):</label> 
                                            <select class="form-control" ng-change="changenumperson(transfer_person)" id="numperson" ng-model="transfer_person" data-ng-options="i  for i in numperson" style="width: 150px;">
                                                    <option value="">0</option>
                                              </select>
                                    </div>
                                     <div class="form-group form-inline">
                                        <label class="label-tour">Price<span> :</span></label>
                                        <input name="transfer_price" ng-model="transfer_price" id="transfer_price" class=" form-control" ng-change="pricetransfer(transfer_price)" pattern="^[0-9]+$"  title="Please input number only." required style="width: 150px;">
                                    </div>
...
<script>
    ...
    $scope.saveAddtransports =function(){
            ...
            //console.log($scope.flight)
             ...
             $http({
                    method : 'POST',
                    url : "../php/addTransfer.php",
                    data: $.param({'name': $scope.tname
                                ,'company_id': $scope.companyid
                                ,'company_name': $scope.companyname
                                ,'person': $scope.person
                                ,'price': $scope.tprice 
                                ,'province': $scope.province_name
                                ,'pro_id': $scope.province_id
                                ,'flight': $scope.flight
                    ...
                    $window.location.href = '../main/view-transfer-package.php#?data='+res;
