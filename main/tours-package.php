                                ...
                                <div class="" style="background: #fff; padding-left: 10px;">                                
                                    ...
                                    <div class="navigate" >
                                        ...
                                        <ol class="breadcrumb" style="margin: 0;padding: 11px;padding-bottom: 0;background: #fff; display: inline-block; ">
                                            ...
                                            <li class="active"><span>/</span> Tours Package</li>
                    ...
                    <div class="booking_searchengine">
                          ...
                          <div class='span6'>
                              ...
                              <ul class="search_list">
                                  ...
                                  <li ng-click="clicklist('Tour Name')">Tour Name</li>

                                  <li ng-click="clicklist('Tour ID')">Package ID</li>

                                  <li ng-click="clicklist('Class')">Class</li>
                      ...
                      <div class="search-box">
                          ...
                          <input type="text" class="search_tourname form-control" ng-model="search.name" placeholder="Tour Name">

                          <input type="text" class="search_tourid form-control" ng-model="search.id" placeholder="Package ID">

                          <input type="text" class="search_class form-control" ng-model="search.class" placeholder="Class">

                          <input type="text" class="search_company form-control" ng-model="search.company_name" placeholder="Company ID">
                                ...
                                <div class="card-content table-responsive">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody >
                                            ...
                                            <tr ng-repeat="item in dataTour | filter:search:strict ">
                                                ...
                                                <td class="col-md-1"><span ng-bind="item.city"></span></td>

                                                <td class="col-md-1"><span ng-bind="item.class"></span></td>

                                               

                                                <td class="col-lg-1 col-md-1"><span ng-bind="item.company_name"></span></td>

                                                <td class="col-lg-2 col-md-2"><span ng-bind="item.contact"></span></td>

                                                

                                                <td class="col-sm-1" align="center"><a href="view-package.php#?data={{item.id}}"><i class="material-icons"  style="color: #9E9E9E; font-size: 25px;">find_in_page</i></a><!-- <a style="cursor: pointer;" ng-click="remove(item)"><i class="material-icons" style="color: #e91e1e;  font-size: 30px;">delete_forever</i></a> --></td>
