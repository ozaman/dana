...
<html lang="en" class="perfect-scrollbar-on"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>View hotel package</title>
                                ...
                                <div class="" style="background: #fff; padding-left: 10px;">                                
                                    <div class="navigate" >
                                        ...
                                        <ol class="breadcrumb" style="margin: 0;padding: 11px;padding-bottom: 0;background: #fff; display: inline-block; ">
                                            ...
                                            <li class="active"> /View Hotel package</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
...
<!-- 
                            ...
                            <tr>
                                <td class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="price-block">
                                        ...
                                        <div ng-if="!editPrice" class="price-block-tail">{{ tours.net_price | currency:'':0 }} <span>Bath / ท่าน</span></div>
                            ...
                            <tr >
                                <td class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="price-block">
                                        ...
                                        <div ng-if="!editPrice" class="price-block-tail">{{ tours.sale_price | currency:'':0 }} <span>Bath / ท่าน</span></div>
                                        <div ng-if="editPrice" class="price-block-tail">
    ...
    margin-bottom: 45px;" >
                            ...
                            <div  class="col-md-3 col-lg-3" ng-if="dataGallery.length != 0" ng-repeat="x in dataGallery">
                                <div align="center">
                                <div  class=" col-md-3 " >
                                    <img style="max-height: 200px; max-width: 356px" ng-src="../../data/files/upload/hotel/gallery/{{x.gallery}}"  class="img-thumbnail img-responsive center-block">
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div>Are you sure to delete tour {{tours.topic}}</div>
                            </div>
...
<script>
    ...
    function loadpage(){
        ...
        $scope.Countryfont = "      Please select country";
            ...
            $http({
                    ...
                    $http({
                        method : 'POST',
                        url : "../php/getHotelpackagebyid.php",
    ...
    $scope.editprice =function(){
        //alert('aaaa')
        $scope.sale_price = $scope.tours.sale_price;
       
        $scope.net_price = $scope.tours.net_price;
  ...
  $scope.addGallery = function(file) {
    console.log(file)
     $http({
               ...
               if (!file) return;
                    Upload.upload({
                        url: '../php/uploadGalleryhotel.php',
    ...
    $http({
                            method : 'POST',
                            url : "../php/removeGalleryhotel.php",
