                                    ...
                                    <table width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td width="50">
                                                ...
                                                <p style="font-weight: 300;width: 80px">From</p>
                                    ...
                                    <table width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td width="80">
                                                ...
                                                <label for="class" class="label-tour" style="color: #555;width: 80px">Agent</label>
                                    ...
                                    <table width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td width="80">
                                                ...
                                                <label for="class" class="label-tour" style="color: #555;width: 80px">Company</label>
                                            ...
                                            <td>
                                                 ...
                                                 <select class="form-control" ng-change="changecompany(selectcompany)" id="selectcompany" ng-model="selectcompany" data-ng-options="i as i for i in dataCompany" id="label-addbooking" style="width: 170px;">
                                        ...
                                        <tbody >
                                            ...
                                            <tr ng-repeat="item in selsedataformonth | filter:search:strict | dateselect:dateselectionfrom:dateselectionto:this ">
                                               ...
                                               <!--  <td  align="center"><i ng-show="item.done == 1" class="material-icons" style="color: #4caf50;">playlist_add_check</i><i ng-show="item.done == 0" class="material-icons"  style="color: #ff9800;">schedule</i></td> -->
                                                ...
                                                <td align="center"  ng-bind="item.company_name"></td>
              ...
              $scope.dataCompanyget = [];
               ...
               $scope.selectagentcheck = agent;
                ...
                angular.forEach( $scope.datatour, function (data) {
                   ...
                   if($scope.checktype == 'Tour' && data.agent_name == agent && $scope.checktype == data.type){
    ...
    $scope.changecompany = function(company){
             ...
             // $scope.databook = [];
                ...
                angular.forEach( $scope.databook, function (data) {
                    ...
                    if(data.company_name == company && $scope.selectagentcheck == data.agent_name ){
