...
<table class="table" width="100%" height="20" border="0"  align="center" cellpadding="0" cellspacing="0" class="">
  <tr align="center">
    <td width="30"  align="center" bgcolor="#ddd" style="padding: 15px 8px;"><strong></strong></td>
    <td width="" align="center" bgcolor="#ddd" style="padding: 15px 8px;"><strong>Invoice
     
    </strong></td>
    <td width="250" align="center" bgcolor="#ddd" style="padding: 15px 8px;" ><strong>Package Name</strong></td>
    <td width="" align="center" bgcolor="#ddd" style="padding: 15px 8px;"><strong>Customer name</strong></td>
    <td width="" align="center" bgcolor="#ddd" style="padding: 15px 8px;"><strong>Flight</strong></td>
    <td width="" align="center" bgcolor="#ddd" style="padding: 15px 8px;"><strong>Pickup place</strong></td>
    <td width="" align="center" bgcolor="#ddd" style="padding: 15px 8px;"><strong>To place</strong></td>
    <td width="" align="center" bgcolor="#ddd" style="padding: 15px 8px;"><strong>Agent</strong></td>
    <td width="" align="center" bgcolor="#ddd" style="padding: 15px 8px;"><strong>Departure Date</strong></td>
    <td width="" align="center" bgcolor="#ddd" style="padding: 15px 8px;"><strong>On time</strong></td>
    <td width="" align="center" bgcolor="#ddd" style="padding: 15px 8px;"><strong>No. of Guest</strong></td>
    <td width="" align="center" bgcolor="#ddd" style="padding: 15px 8px;"><strong>Type</strong></td>
    ...
    //$date = date('d/m/Y',$midnight);
     $dates = '05/08/2017';
     //echo $dates;
    $sql =  "select * from dn_booking as TB_booking  WHERE booking_date BETWEEN '".$date."' AND  '".$date2."'status  = 0 AND ondate = '".$_GET[date]."' AND type = '".$_GET[type]."' ORDER BY ontime ASC"; 
