...
<body ng-app="myApp" ng-controller="myCtrl">
               ...
               <!--  <div class="user">
                ...
                <ul class="nav">
                    ...
                    <li >
                        ...
                        <div class="collapse" id="pagesExamples" aria-expanded="true">
                            <ul class="nav"> 
                                <li >
    ...
    display: inline-block; ">
                                            ...
                                            <li class="active"><i class="fa fa-calendar-check-o fa-fw"></i> / Bookings Detail</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
    ...
    padding: 15px;
    border-radius: 4px;"> 
                    <table class="table table-striped bookdetail" ng-repeat="x in detail" style="">
                        <!-- <tr>
                            <td class="field">Booking id</td>
                            <td>{{ x.booking_id }}</td>
                        </tr> -->
                        <tr>
                            <td class="field">Booking ID</td>
                        ...
                        <tr>
                            ...
                            <td>{{ x.booking_date | date:"dd/MM/yyyy 'at' hh:mm a" }}</td>
                        </tr>
                        <tr>
                            <td class="field">Departure Date</td>

                            <td>{{ x.ondate | date:"dd/MM/yyyy" }}&nbsp;at&nbsp;{{ strTime }}</td>


                            <!-- <td>{{ res | date:"dd/MM/yyyy 'at' hh:mm a" }}</td> -->


                        </tr>
                        
                        <tr>
                            <td class="field">Package name</td>
                            <td>{{ x.package_name }}</td>
                        </tr>
                        <tr>
                            <td class="field">Package ID</td>
                            <td>{{ x.program }}</td>
                        </tr>
                        <tr ng-if="x.type != 'Transfer'">
                            <td class="field">Class</td>
                            <td>{{ x.pro_class }}</td>
                        </tr>
                        <tr ng-show="!isPartner">
                            <td  class="field">Company</td>
                            <td>{{ x.company_name }}</td>
                        </tr>
                        <tr>
                            <td class="field">Custumer Name</td>
                            <td>{{ x.name }}</td>
                        </tr>
                        <tr>
                            <td class="field">Custumer Email</td>
                            <td>{{ x.email }}</td>
                        </tr>
                        <tr>
                            <td class="field">Custumer Phone</td>
                            <td>{{ '+'+x.phonecode+x.phone }}</td>
                        </tr>
                        <tr>
                            <td class="field">Room Number</td>
                            <td>{{ x.room_number }}</td>
                        </tr>
                        <tr>
                            <td class="field">Pickup place</td>
                            <td>{{ x.pickup_place }}</td>
                        </tr>
                        <tr>
                            <td class="field">To place</td>
                            <td>{{ x.to_place }}</td>
                        </tr>
                        <tr>
                            <td class="field">Guest (Adult)</td>
                            <td>{{ x.adult }}</td>
                        </tr>
                        <tr>
                            <td class="field">Guest (Child)</td>
                            <td>{{ x.child }}</td>
                        </tr>
                        
                        
                        <!--<tr ng-show="KioskOwner">
                            <td class="field">Total Price</td>
                            <td>{{ x.pickup_price+x.sale_total_price }}</td>
                        </tr>-->
                        <tr>
                            <td class="field">Agent Name </td>
                            <td>{{ x.agent_name }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr ng-if="x.type =='Transfer'" >
                            ...
                            <td class="field">Transfer Price</td>
                            <td>{{ x.transfer_price | currency:'':0 }}</td>
                        </tr>
                        <tr ng-if="x.type =='Tour'">

                            <td class="field">Adult Contract Rate</td>
                            <td>{{ x.net_price_adult | currency:'':0 }}</td>
                        </tr>
                        <tr ng-if="x.type =='Tour'">

                            <td class="field">Adult Selling Rate</td>
                            <td>{{ x.adult_price | currency:'':0 }}</td>
                        </tr>
                        <tr ng-if="x.type =='Tour'">

                            <td class="field">Child Contract Rate</td>
                            <td>{{ x.net_price_child | currency:'':0 }}</td>
                        </tr>
                        <tr ng-if="x.type =='Tour'">

                            <td class="field">Child Selling Rate</td>
                            <td>{{ x.child_price | currency:'':0 }}</td>
                        </tr>
                        <tr >
                            <td class="field">Total price</td>
                            <td>{{ x.total_price | currency:'':0}}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td ng-show="x.status==1">Complete</td>
                            <td ng-show="x.status==3">Cancellation</td>
                            <td ng-show="x.status==0">Wait</td>
                        </tr>
                        <tr>
                            <td class="field">Post By</td>
                            
                            <td ng-bind="x.user_name">Wait</td>
                        </tr>
                    </table>
                    </div>
