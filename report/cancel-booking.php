                                ...
                                <div class="" style="background: #fff; padding-left: 10px;">                                
                                    ...
                                    <div class="navigate" >
                                        ...
                                        <ol class="breadcrumb" style="margin: 0;padding: 11px;background: #fff; display: inline-block; ">
                                            ...
                                            <li class="active"><span>/</span>  Cancel bookings
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody >
                                            ...
                                            <tr ng-repeat="item in databook | filter:search:strict  ">
                                                ...
                                                <td align="center"> <i class="material-icons" style="color: #f44336;font-size: 18px;">cancel</i><!-- <i class="fa fa-times-circle-o fa-lg" aria-hidden="true" > --></i><!-- <i class="material-icons" >assignment_turned_in</i> --></td>
